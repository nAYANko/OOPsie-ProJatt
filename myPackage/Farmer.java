   ...
   public  void setFarmerID(String num){
    ...
    public void Register(){
        try{
            ...
            IDfileWriter.close();
            count++;
            String filepath = "C:\\Users\\hp\\Desktop\\mini_project-main\\chat\\" + getFarmerID() + ".txt";
    ...
    public void deleteFarmer(String id){
        String path = "C:\\Users\\hp\\Desktop\\mini_project-main\\chat\\"+getFarmerID()+".txt";
        try{
    ...
    public String seeMessage() {
        ...
        try {
            ...
            while (reader.hasNextLine()) {
                messages.append(reader.nextLine()).append("\n");
            }
            if (messages.length() == 0) {
                messages.append("No updates from the government\n");
            }
        } catch (IOException e) {
            messages.append("Error reading messages: ").append(e.getMessage()).append("\n");
        }
